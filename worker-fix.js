...
SAUDI IDENTITY:
Use an accurate Saudi green-and-white flag as a natural part of the scene. Draw visual inspiration from the OFFICIAL 2026 National Day identity: Saudi geometric line work and refined textile-inspired patterns, with an elegant green-and-white national palette. Saudi palm trees and subtle crossed-swords/palm symbolism may appear where appropriate. Use authentic Saudi clothing, architecture, landscape or modern Saudi innovation according to the feeling. The image must unmistakably read as Saudi Arabia and specifically Saudi National Day 96 through its visual story and 2026 identity-inspired motifs, not through written text.

ART DIRECTION:
Premium cinematic digital painting / fine-art illustration, sophisticated museum-quality composition, realistic Saudi details, natural human anatomy and faces, rich but tasteful Saudi green accents, cinematic golden or natural light, atmospheric depth, elegant color harmony, high detail, emotionally moving, suitable for a professional school exhibition. Avoid clip-art, children's cartoon style, stock-photo look, generic AI collage, generic mosque poster, or a repetitive family-and-mosque template.
...
Do NOT depict National Day 95. Do NOT depict Founding Day brown/beige branding. Do NOT make a mosque the main subject unless the participant's text explicitly asks for it. Do NOT force a mosque, family, fireworks and palm trees into every image.
The application will add the exact official wording after generation.`;

   // FLUX.2 [dev] uses multipart form data through the Workers AI binding.
   ...
   var req=new Request("http://flux2.local",{method:"POST",body:form});
   var result=await env.AI.run(MODEL,{multipart:{body:req.body,contentType:req.headers.get("content-type")||"multipart/form-data"}});
