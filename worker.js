  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/api/generate" && request.method === "POST") {
      try {
        ...
        const prompt =
          "Create ONE spectacular original cinematic fine-art exhibition painting specifically for Saudi National Day 96. " +
          "Make it unmistakably Saudi and celebratory, not a generic desert landscape. Selected emotions: " + visualMood + ". " +
          "Show emerald green and white accents, elegant flowing green fabric, festive light, subtle distant fireworks, Saudi heritage architecture, traditional geometric patterns, date palms, desert mountains and authentic Arabian textures. " +
          "Blend heritage into a clearly modern Saudi future: contemporary Riyadh-style skyline, advanced roads, elegant futuristic buildings, innovation and glowing city lights. Show a visual journey from heritage to progress in ONE unified scene. " +
          "Use gold, emerald green, ivory, sand, bronze and deep teal, dramatic sunrise or sunset, cinematic atmosphere, realistic materials, rich depth, volumetric light and sophisticated museum-quality painterly detail. " +
          "Pride: majestic scale and radiant achievement. Belonging: warm heritage, palms and human connection. Hope: sunrise, open horizons, greenery and a luminous future. Ambition: innovation, modern architecture and forward movement. Joy: festive light and graceful green movement. " +
          "Saudi National Day 96 must be the clear theme through national colors, heritage, celebration and modern transformation. " +
          "ONE cohesive scene only; no triptych, split panels, collage, poster, infographic, cartoon, anime or flat vector style. " +
          "No literal Saudi flag, banners, signs, plaques, screens or objects containing writing. ABSOLUTELY NO TEXT OR LETTERS: no Arabic, English, numbers, calligraphy, captions, logos, watermark, signatures or readable symbols. " +
          "Express the emotions only through color, composition, lighting, heritage, celebration and future symbolism.";
