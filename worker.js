  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/api/generate" && request.method === "POST") {
      try {
        ...
        const prompt =
          "Create ONE cohesive original cinematic fine-art painting celebrating Saudi National Day 96. " +
          "Selected emotions: " + visualMood + ". " +
          "Show pride, belonging, hope and national joy through visual storytelling only. " +
          "Blend authentic Saudi heritage with modern transformation in one harmonious scene: date palms, Arabian desert and mountains, elegant mud-brick heritage architecture, subtle geometric motifs, brass dallah and woven textiles flowing naturally toward a luminous modern Saudi city, advanced roads, contemporary architecture and a hopeful futuristic horizon. " +
          "Use emerald green, ivory, warm sand, bronze, teal and radiant golden-hour light. " +
          "Premium museum-quality exhibition artwork, realistic materials, cinematic depth, atmospheric perspective, volumetric sunlight, refined painterly brushwork, rich shadows, sophisticated composition and emotional atmosphere. " +
          "Pride: majestic scale and uplifting light. Belonging: warm heritage and human connection. Hope: sunrise, renewal and open horizons. Ambition: progress, innovation and forward movement. Joy: celebratory light and graceful movement. " +
          "One scene only; no triptych, split panels, collage, poster, infographic, cartoon, anime or flat vector style. " +
          "No flags, banners, signs or objects containing writing. Use only abstract flowing green fabric or green light for national color inspiration. " +
          "ABSOLUTELY NO TEXT: no Arabic letters, English letters, words, numbers, calligraphy, captions, logos, watermark, signatures or readable symbols. " +
          "Communicate everything through color, light, scenery, heritage, people, architecture, development and symbolism.";
