  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/api/generate" && request.method === "POST") {
      try {
        ...
        const prompt =
          "Create ONE cohesive, original, museum-quality cinematic fine-art painting celebrating Saudi National Day 96. " +
          "The artwork must visually express these selected emotions: " + visualMood + ". " +
          "Blend Saudi heritage with modern development in one harmonious scene: elegant palm trees, dramatic desert and mountains, traditional mud-brick architecture, refined Najdi-inspired geometric heritage patterns, a beautiful dallah and woven textile details, then transition naturally toward a luminous contemporary Saudi skyline, modern roads and futuristic architecture. " +
          "Show a clear sense of national pride, belonging and optimism through composition, light, movement and symbolism. " +
          "Use a sophisticated palette of deep Saudi-inspired green, ivory, warm sand, bronze, teal and glowing golden sunrise light. " +
          "Rich atmospheric depth, cinematic golden-hour lighting, highly detailed painterly brushwork, elegant visual storytelling, premium art-exhibition quality, emotionally powerful, original composition. " +
          "Do NOT make a triptych or split panels. Do NOT make it look like a poster or graphic design. " +
          "Do not show any national flag or any object that normally contains writing. Use flowing abstract green fabric only as a color and movement element, without symbols or writing. " +
          "ABSOLUTELY NO TEXT OF ANY KIND: no Arabic letters, no English letters, no words, no numbers, no calligraphy, no captions, no signs, no banners, no logos, no watermark, no readable symbols. " +
          "The feelings should appear only through visual atmosphere, colors, scenery and symbolism, never as written language.";

        const negative_prompt =
          "text, Arabic text, Arabic letters, English text, letters, words, numbers, typography, calligraphy, captions, subtitles, watermark, logo, signature, label, sign, street sign, banner, poster, advertisement, flag, Saudi flag, writing, readable symbols, book text, screen text, plaque, newspaper, triptych, split screen, collage, infographic, graphic design";
